...
class SList:
    ...
    def remove_dups(self):
        ...
        for i in range (len(templist)-1,-1,-1):
            my_temp.add_to_front(templist[i])

        self.head = my_temp.head
        return self
...
my_list.add_to_front(3).add_to_back(3).add_to_front(1).add_to_back(1).print_values()
my_list.remove_dups().print_values()
